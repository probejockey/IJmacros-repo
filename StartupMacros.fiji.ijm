...
macro "Flood Foll Tool - C037B21P085373b75d0L4d1aL3135L4050L6166D57D77D68La5adLb6bcD09D94" {
	requires("1.34j");
	setupUndo();
	getCursorLoc(x, y, z, flags);
...
macro "Plot Tool - C037La077Ld098L6859L4a2fL2f4fL3f99L5e9bL9b98L6888L5e8dL888c" {
	runMacro("F:\\IJMacros\\Plot_points.ijm");
}
...
macro "Run Stage Calibration with tracking " {
	runMacro("F:\\IJMacros\\Stage-calibrate-1.1.ijm");
}
...
macro "Run Analysis Map" {
	runMacro("F:\\IJMacros\\Analysis_Map-2.0.ijm");
}

macro "Run Annotate Probe Tracking Images" {
	runMacro("F:\\IJMacros\\Scale and centre spot probe tracking images.ijm");
}